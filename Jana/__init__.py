...
if ENV:
    ...
    from Jana.config import Development as Config
...
pbot = Client("Jana", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from Jana.modules.helper_funcs.handlers import (
