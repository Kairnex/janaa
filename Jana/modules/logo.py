...
from Jana.modules.nightmode import button_row
from Jana import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from Jana.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./Jana/resources/fonts/*")
